...
const SYSTEM_PROMPT = `You are a helpful assistant that answers questions based on provided document context.
...
- If the context is insufficient, say: "I don't have enough information in the uploaded documents to answer this."
 ...
 */
export async function askQuestionWithContext(question, userId, fileIds = [], history = []) {
